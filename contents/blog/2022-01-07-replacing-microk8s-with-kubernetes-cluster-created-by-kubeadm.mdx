...
When I first created this blog, I went with the most cost effective solution by deploying only a single EC2 instance running MicroK8s. To learn more about the original setup you can read my [previous post](/post/2021-09-24-setting-up-microk8s-and-a-nfs-server-using-ansible).
