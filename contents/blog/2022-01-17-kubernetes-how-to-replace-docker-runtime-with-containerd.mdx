...
As everything I've built for my blog here is based on IaC, I have also updated the [Ansible playbook](https://github.com/88lexd/lexd-solutions/tree/main/aws-wordpress/2-os-configuration) to install and configure containerd instead of using Docker.
