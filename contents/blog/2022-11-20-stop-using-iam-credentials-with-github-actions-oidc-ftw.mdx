...
If you would like to see the actual source code I have, feel free to check out my [GitHub repo](https://github.com/88lexd/lexd-solutions/blob/main/.github/workflows/lambda-to-s3-jumpbox-uptime.yml).
