...
For those who wants to jump straight to the Terraform IaC which I am using. The code is available in my [GitHub Repository](https://github.com/88lexd/lexd-solutions/tree/main/wordpress/1-infra-configuration/3-cloudflare).
