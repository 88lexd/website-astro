...
https://lexdsolutions.com/post/2022-01-07-replacing-microk8s-with-kubernetes-cluster-created-by-kubeadm

This is part 2 of 3 to my “how I built this blog” series.

If you haven't seen part 1 already, then please take a look at my previous blog "[Using CloudFormation and Terraform on my Brand New AWS Account](/post/2021-09-21-using-cloudformation-and-terraform-on-my-brand-new-aws-account)" as it shows how the base infrastructure is setup.
...
As I already mentioned this in [part 1](/post/2021-09-21-using-cloudformation-and-terraform-on-my-brand-new-aws-account) of the series. From the very beginning, I wanted to keep costs to the minimum, yet providing me the exposure to using all the IaC tools I set out to use.
...
Next: [Part 3 - Deploying WordPress and MySQL on Kubernetes using Helm Chart](/post/2021-09-27-deploying-wordpress-and-mysql-on-kubernetes-using-helm-chart)
