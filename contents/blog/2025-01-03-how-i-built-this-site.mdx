...
2. Refactor and migrate the [cloudflare Terraform code](https://github.com/88lexd/lexd-solutions/tree/main/wordpress/1-infra-configuration/3-cloudflare) into the [new repo](https://github.com/88lexd/website-astro) for this blog.
