...
- Automation on AWS end - [https://github.com/88lexd/lexd-solutions/tree/main/aws-wordpress/1-infra-configuration/2-general-setup](https://github.com/88lexd/lexd-solutions/tree/main/aws-wordpress/1-infra-configuration/2-general-setup)
...
Important note: _The following is only a snippet of how the Lambda is created. To see all the code, check out my [lambda\_codedeploy.tf](https://github.com/88lexd/lexd-solutions/blob/main/aws-wordpress/1-infra-configuration/2-general-setup/lambda_codedeploy.tf) file._
...
For the full source code, see [codedeploy\_lambda.py](https://github.com/88lexd/lexd-solutions/blob/main/aws-wordpress/1-infra-configuration/2-general-setup/lambdas/codedeploy_lambda.py).
...
See: [setup-aws-codedeploy-agent.yml](https://github.com/88lexd/lexd-solutions/blob/main/aws-wordpress/2-os-configuration/ansible_tasks/setup-aws-codedeploy-agent.yml)
