...
This is a follow up on my previous post called: [Tagging EBS Volumes by Using the Attached Instance Tags](/post/2021-11-18-aws-tagging-ebs-volumes-by-using-the-attached-instance-tags).
