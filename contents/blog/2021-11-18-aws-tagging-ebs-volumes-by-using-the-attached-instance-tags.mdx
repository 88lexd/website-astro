...
As a security best practice, before I executed this script, I had to assume role into my Admin role first. To learn more about what Assume Role is, take a look at my previous [blog post](/post/2021-09-29-how-to-assume-role-on-aws-and-using-python).
