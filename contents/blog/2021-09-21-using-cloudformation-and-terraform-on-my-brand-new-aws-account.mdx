...
See my blog post here for more details: [Replacing MicroK8s with Kubernetes Cluster Created by kubeadm](/post/2022-01-07-replacing-microk8s-with-kubernetes-cluster-created-by-kubeadm).
...
Next: Part 2 – [Ansible to Setup MicroK8s and a NFS Server on Ubuntu 20.04](/post/2021-09-24-setting-up-microk8s-and-a-nfs-server-using-ansible)
