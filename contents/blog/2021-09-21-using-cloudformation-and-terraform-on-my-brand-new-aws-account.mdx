...
This section references the source code here on my **[GitHub page.](https://github.com/88lexd/lexd-solutions/tree/main/wordpress/1-infra-configuration/1-base-setup-cfn)**
...
This section references the source code here on my [**GitHub page**](https://github.com/88lexd/lexd-solutions/tree/main/wordpress/1-infra-configuration/2-general-setup-aws-old).
...
**Using S3 and DynamoDB as the Backend** ([main.tf](https://github.com/88lexd/lexd-solutions/blob/main/aws-wordpress/1-infra-configuration/2-general-setup/main.tf))
...
**VPC (Virtual Private Cloud)** ([vpc.tf](https://github.com/88lexd/lexd-solutions/blob/main/aws-wordpress/1-infra-configuration/2-general-setup/vpc.tf))
...
**Data Lifecycle Manager** ([dlm.tf](https://github.com/88lexd/lexd-solutions/blob/main/aws-wordpress/1-infra-configuration/2-general-setup/dlm.tf))
...
For second part of this series, I will be talking about how I configured the OS (Ubuntu 20.04) using Ansible. If you would like to look ahead, the code can be found here on my [GitHub page](https://github.com/88lexd/lexd-solutions/tree/main/aws-wordpress/2-os-configuration).

I hope you enjoyed this post I look forward to writing part two of this series.

Next: Part 2 – [Ansible to Setup MicroK8s and a NFS Server on Ubuntu 20.04](https://lexdsolutions.com/2021/09/setting-up-microk8s-and-a-nfs-server-using-ansible/)
